...
public class Controller19 {
	...
	public void method7(HttpServletRequest req, HttpServletResponse rep) throws IOException {
		String location = req.getContextPath() + "/ex19/sub08";
		rep.sendRedirect(location);
	}
	
	@RequestMapping("sub09")
	public String method8() {
		return "redirect:/ex19/sub010";
	}
