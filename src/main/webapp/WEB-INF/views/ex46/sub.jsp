...
<body>
	...
	<br>
	<button id="btn2">/ex46/sub02</button>
	<br>
	<button id="btn3">/ex46/sub01</button>
	<br>
	<button id="btn4">/ex46/sub01</button>
	<br>
	<button id="btn9">/ex46/sub01 9번</button>
...
document.querySelector("#btn2").addEventListener("click", function(){
	fetch(ctx+"/ex46/sub02").then(function(){
		console.log("응답 후 실행해야하는 코드1");
		console.log("응답 후 실행해야하는 코드2");
		
	}).then(function(){
		console.log("응답 후 실행해야하는 코드3");
		console.log("응답 후 실행해야하는 코드4");
	})
})
