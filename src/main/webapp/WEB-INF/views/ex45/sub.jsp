...
<body>
	...
	<br>
	<button id="btn9">/ex45/sub09 응답 본문 </button>
	<br>
	<button id="btn10">/ex45/sub10</button>
	<br>
	<button id="btn11">/ex45/sub11</button>
	<br>
	<button id="btn13">/ex45/sub13</button>
	<br>
	<button id="btn14">14번 버튼</button>
	<br>
	<button id="btn15">15번 버튼</button>
